...
from web.api.api_utils import generate_response, ChatRequest, clean_text
...
def reflect(request: ChatRequest):
    ...
    try:
        ...
        messages = [{"role": "system", "content":
            ...
            f"Khuyến khích suy nghĩ sâu sắc hơn và đặt từ 2 đến 3 câu hỏi mở. Trả lời trong bằng tiếng việt."
                     }]
